...
(function (root, factory) {
    ...
    function teeSVG(c) {
        ...
        s += '<path d="M118,178 L118,250 L120,398 C130,401 142,403 154,404 L150,210 C138,199 127,189 118,178 Z" fill="url(#sideL)"/>';
        s += '<path d="M282,178 L282,250 L280,398 C270,401 258,403 246,404 L250,210 C262,199 273,189 282,178 Z" fill="url(#sideR)"/>';
        // sleeve seams + hems
    ...
    function poloSVG(c) {
        ...
        s += '<path d="' + body + '" fill="' + c + '"/>';
        s += '<path d="' + body + '" fill="url(#bodyShade)"/>';
        s += '<path d="M118,180 L118,252 L120,400 C130,403 142,405 154,406 L150,212 C138,201 127,191 118,180 Z" fill="url(#sideL)"/>';
        s += '<path d="M282,180 L282,252 L280,400 C270,403 258,405 246,406 L250,212 C262,201 273,191 282,180 Z" fill="url(#sideR)"/>';
    ...
    function hoodieSVG(c) {
        ...
        s += '<path d="' + body + '" fill="' + c + '"/>';
        s += '<path d="' + body + '" fill="url(#bodyShade)"/>';
        s += '<path d="M112,198 L112,262 L114,406 C124,409 136,411 148,412 L144,228 C132,217 121,208 112,198 Z" fill="url(#sideL)"/>';
        s += '<path d="M288,198 L288,262 L286,406 C276,409 264,411 252,412 L256,228 C268,217 279,208 288,198 Z" fill="url(#sideR)"/>';
    ...
    function capSVG(c) {
        ...
        // bill
        s += '<path d="M84,202 C130,184 270,184 316,202 C314,230 264,248 200,248 C136,248 86,230 84,202 Z" fill="' + bill + '"/>';
        s += '<path d="M84,202 C130,184 270,184 316,202 C314,230 264,248 200,248 C136,248 86,230 84,202 Z" fill="url(#bodyShade)" opacity="0.7"/>';
        s += '<path d="M96,216 C144,236 256,236 304,216 C294,238 252,246 200,246 C148,246 106,238 96,216 Z" fill="' + under + '" opacity="0.3"/>';
        s += stitchLine('M96,206 C140,191 260,191 304,206', true);
        s += stitchLine('M101,214 C144,198 256,198 299,214', true);
        s += stitchLine('M107,222 C150,205 250,205 293,222', true);
