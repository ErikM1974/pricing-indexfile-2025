/**
 * dst-viewer.js — NWCA DST Studio (production DST viewer).
 *
...
(function () {
    ...
    function exportMockupPNG() {
        ...
        // Customer-facing artwork: sign it with the company, not the internal tool name.
        c.fillText('Northwest Custom Apparel — thread colors are digital approximations', margin, H - 26);
    ...
    function summaryText() {
        ...
        lines.push('');
        lines.push('Generated by NWCA DST Studio');
        return lines.join('\n');
    }
