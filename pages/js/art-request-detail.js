...
(function () {
    ...
    if (!EMAILJS_SERVICE_ID) console.error('[art-request-detail] APP_CONFIG.EMAIL.SERVICE_ID missing — EmailJS is not configured');
    ...
    if (!EMAILJS_PUBLIC_KEY) console.error('[art-request-detail] APP_CONFIG.EMAIL.PUBLIC_KEY missing — EmailJS is not configured');
    ...
    const REP_MAP = {
        ...
        // Ruth's real inbox + Slack is ruth@ (ruthie@ is not a real account);
        // ArtRequests stores her as "Ruthie" — alias "Ruth". Keep in sync with
        // rep-email-map.js + art-actions-shared.js REP_EMAIL_MAP.
