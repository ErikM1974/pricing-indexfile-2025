...
In progress: shared_components/css/vendor-invoice.css — unified vendor invoice document layout; legacy AE ownership retained separately during review.

In progress: shared_components/css/purchasing-workspaces.css — scoped purchasing/payables layout paired with canonical controls. Existing page owners stay until all consumers migrate.

In progress: shared_components/css/staff-import-tools.css — shared SanMar file-tool layout; original owners remain until their consumers migrate.
