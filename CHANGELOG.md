...
## v2026.09.07.23 (2026.09.07)

- Deploy v2026.09.07.23: server split, second cut — staff SAML, vendor portal, customer portal and quote data plane moved verbatim into routes/ (4 modules, 92 registrations; server.js 14,600 → 10,561 lines; registration order unchanged by the route-table lock; boot + request smoke on every moved gate)
...
- Deploy v2026.09.06.28: AE dashboard control names
...
- Deploy v2026.09.06.16: calculators final hygiene pass
...
- Deploy v2026.09.05.51: Production Shifts + Roland Supplies review (9 items); remove stray x.js
...
- Deploy v2026.09.04.6: 2 files (ae-dashboard.html, monogram-dashboard.html...)
...
- Deploy v2026.09.03.16: 1 files (index.html...)
...
- Deploy v2026.07.27.3: cache-bust Mission Control assets
...
- Deploy v2026.07.18.9: cache-bust leads board assets
