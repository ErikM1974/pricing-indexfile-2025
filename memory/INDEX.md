...
- [STOREFRONT_CHECKOUT_PROPOSAL_2026-07.md](STOREFRONT_CHECKOUT_PROPOSAL_2026-07.md) — PROPOSAL (awaiting Erik + 4 decisions): deposit-on-accepted-quote online payment (reuse 3DT Stripe rails + `Order_Payments` ledger), catalog redesign quick wins, funnel fixes (accept-CSRF, quote versioning)
