...
| [`CSS_STANDARDIZATION_PLAN_2026-09.md`](CSS_STANDARDIZATION_PLAN_2026-09.md) | **Project brief for a fresh session**: CSS one-off sprawl (295 files, 1,355 colours, 3,182 !important) → tokens + components + stylelint + family-by-family pixel-verified migration; kickoff prompt inside |
