...
| File | What it holds |
|---|---|
| [`december-finish-line.md`](december-finish-line.md) | December Finish Line attached folders, current report/source map, financial assumptions, and private website integration notes |
