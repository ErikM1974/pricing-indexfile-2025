...
| [`CSS_STANDARDIZATION_PLAN_2026-09.md`](CSS_STANDARDIZATION_PLAN_2026-09.md) | **CSS standardization — DONE 2026-09-07** (`v2026.09.07.3` → `.20`): plan + § 2 baseline, § 8 per-family log (newest first), § 9 final census; the toolkit is `scripts/css/README.md`, the staff reference `/dashboards/brand-standards.html` |
| [`CSS_UNIFICATION_2026-09.md`](CSS_UNIFICATION_2026-09.md) | **Next CSS phase: shared components and visual design** — measured audit, staff/customer concept, theme/density choices, family migration and retirement gates; plan prepared after v2026.09.07.38 |
| [`SERVER_SPLIT_2026-09.md`](SERVER_SPLIT_2026-09.md) | **server.js → routes/ split, IN PROGRESS (2026-09-07)**: section map with what each cut needs first, the route-table lock, the extraction tool, the one-agent-at-a-time rule; § 8 progress log |
...
- [Garment liability waiver e-sign](GARMENT_WAIVER_2026-09.md) — customer e-signature page, evidence stored, EmailJS template contract, Inbox statuses, gotchas.
