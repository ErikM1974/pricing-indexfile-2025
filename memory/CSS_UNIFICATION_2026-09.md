...
Erik resumed from the saved checkpoint. Full local report checks are complete, the remote checkout and running .17 release are unchanged, and exact-source release checks are next. Standing edit/deploy authorization continues.
