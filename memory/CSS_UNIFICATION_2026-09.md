...
- [ ] Capture original four-width report, staff-gate, populated audit and paper evidence.
- [ ] Consolidate CSS and generator layout with source locks on report data and money formatting.
- [ ] Verify keyboard sorting/navigation, incomplete/error recovery, precise financial tables and complete paper.
