...
## ACTIVE — five staff workspace drafts reviewed, 2026-09-10
...
- LIVE: v2026.09.10.2 / Heroku 2098 / df7bebed30da524464df4db1c40904191285f31d; 170/225 pages live, 55 pending. Backend unchanged .1 / Heroku 1130. Five additional reviewed drafts: Drain-Pro, production shifts, payroll, Mission Control and Company Numbers; candidate 175/225, 50 pending, not live credit.
- Company Numbers: three shared/scoped CSS sheets total 95,393 LF bytes versus original 215,633 across eight sheets (56% smaller). Public Sans, navy/gold header, consistent 44px controls, readable eight-widget reporting through 320px, three columns at 1920px. The page's legacy stylesheet is retired; shared legacy dashboard sheets stay for other consumers. No business math, API payload, rep attribution or privacy-boundary changes.
- Company review: 11 original/current browser scenarios passed, four-width accessibility plus wide-screen geometry, exact original monetary/date-window comparisons, empty/failure/recovery, failed refresh after success, direct Retry, delayed revenue success/error, unavailable comparison and fallback goals. Four focused suites / 589 checks passed; changed controller ESLint and new owner Stylelint clean. The four-page Letter report retains all original monetary occurrences plus six production costs and blanks statuses previously hidden in print. Every page inspected; all headings and row identifiers verified.
- Shared report controllers now announce actual rendered results; failed loads clear prior totals/dates/charts, recovered sample errors disappear, retries refresh their stamp and obsolete revenue responses cannot replace the selected range. The header distinguishes incomplete reads. Source fixture: 61 hashes, 201 reversible mappings and five retired stylesheet originals. All test APIs fail closed; no real business writes or notifications.
- Mission Control remains reviewed at a9595896: 16 browser scenarios, 535 focused checks, ten documents / 21 printed pages. Native dialogs, shared vendor-inbound/vendor-box-labels/vendor-invoice owners, identity/tab/preview lifetimes and print ownership preserved. Prior Drain-Pro/shifts/payroll reviews remain valid; all five drafts are undeployed.
- Next: Quote Management original/current mocked browser fixtures, responsive layout and native dialogs using the shared vendor owners. Then full family integration, all application gates, actual exact-source CI and one verified release. Shared runtime, generated documents and external-provider UI remain separate unfinished tracks.
- Never rerun one-shot migration or shutdown helpers. node_modules is a junction into primary: never recursively delete it; no .env copied. Stage explicit owned paths. Standing edit/deploy authorization continues.
