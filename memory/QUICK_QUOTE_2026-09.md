...
- Deployment pending: bump the document/workspace script cache versions during release, preserve historical source mappings, and run the release gates. The deployed Quick Quote speed release remains v2026.09.14.2 until explicitly verified otherwise.
