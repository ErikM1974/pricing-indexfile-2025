...
- ⏳ **DEFERRED (Inksoft round):** creditcard-atmos, gift-certs, commissions approve/mark-paid, manageorders/orders/create — need Python Inksoft caller edits + `CRM_API_SECRET` on `inksoft-transform`.
