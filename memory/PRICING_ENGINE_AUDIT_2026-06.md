...
**HIGH leverage**
- **Lock catalog matrices to the engine** (EMB-1 / SCP-1 / DTF-2 / DTF-3 / DTG-2) — engine-probe
  like Quick Quote, or add matrix==engine parity tests. Closes the whole "matrix is a 2nd
  formula" class in one move.
