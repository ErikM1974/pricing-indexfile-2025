...
proves nothing. 🔑 Verification: a JS probe of `.hidden` is a probe of INTENT, not of the pixels. (2026-09-05)
...
<!-- Archived 2026-08-26: LESSONS_LEARNED.md had reached 332 lines (hard limit 300). -->
...
## curl from git-bash mangled em dashes into U+FFFD inside a Caspio row (2026-08-25, archived 2026-09-01)
...
<!-- archived 2026-09-01 from LESSONS_LEARNED.md -->
...
## 2-minute proxy outage: the commit shipped half the change, and the boot probe tested the other half (2026-08-27, archived 2026-09-05)
...
## Retired short references — preview tool review 2026-09-09

These resolved items were already archived in full; redundant active-memory references move here to retain their wording.
...
## Archived short references retained during product detail review — 2026-09-09
...
## Pricing reports cleanup — resolved short references moved from active lessons
...
## Resolved references consolidated during CRM review (2026-09-09)
...
## Archived 2026-09-11 — resolved training and reference migrations
...
Ten resolved one-time fixes from the 2026-09-11/13 CSS-unification pass, moved out of the
active log to keep it under its 250-line target. Each shipped and is locked by a test.
