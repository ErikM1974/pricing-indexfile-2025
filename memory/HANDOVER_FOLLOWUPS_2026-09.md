...
Erik resumed; standing edit/deploy authorization continues. **Frontend v2026.09.08.19 / Heroku 2078 is LIVE**, full SHA **ebe337a965da3bc236c0f5fab8f8aceb67292950**, actual slug verified 2026-09-09T06:45:55.1307087Z. Exact-source CI **34319634271** passed all four jobs, including money/calculator parity, on **1919b192842f41790e1cc12142c411bf07539465**. Twelve deployed runtime CSS/JS assets match committed bytes. The four policy shells retain public reading access; admin/staff API permissions remain unchanged. The migration tracker and four regression staff shells remain protected; ten public/regression shells return200. No business writes or notifications.

**72 reviewed application pages live;153 pending**, from225 application/served-archive HTML sources. Another79 tracked HTML sources are excluded. All26 training pages are reviewed/live. Ignored training/api-test-runner.html is not tracked/deployed; leave it alone. Generated document/style owners remain separate unfinished work.

### Next batch and plan

- [x] Deploy Policies Hub, Policy Detail, Open Questions and Handbook (.19), following policy references/notices (.18) and four API references (.17).
- [x] Preserve published policy bodies, authentication/API client and downloadable handbook. Verify actual editing, failed save/post recovery, loaded parents, missing editor/sanitizer, resolved staff comment identity, visible retry, native contents/AI dialog, complete printed chapters and collapsed chart teams.
- [x] Next twelve public webstore pages reviewed and committed in **C:/Users/erik/.codex/visualizations/2026/09/07/01a07d90-9a4c-7e70-9e4e-c196377b7c6b/training-final-worktree**, branch **codex/webstore-family**, reviewed commit **22ce02d60aca7e118ed23a6b3af8ce9e3b09b638**, base **32cd5e640c9a304f1cf4f1f1650efdb7d12553bb**. It is NOT deployed. node_modules is a junction; no .env copied.
- [x] Webstore group: rebuilt company-webstores.css with shared tokens/components/Public Sans; removed borrowed golf CSS. All25 focused browser cases and150 content/ownership cases pass, including all12 public aliases, four widths/axe, native FAQ/navigation, print restoration, complete original main text, SEO/JSON-LD, imagery and destinations. Actual PDFs preserve773 checked prose/price/FAQ blocks. Raw CSS graph81,097 →70,707 bytes (12.8% smaller). Final full-copy guard separately12/12.
- [ ] Integrate webstores preserving this .19 record, run full local gates, version assets, require exact-source CI and verify actual deployment. Candidate84 is not live; after that verified release the remaining count would be141.
- [ ] Continue remaining staff, storefront/brand, calculator/builder and generated-document families.

### Verification / resume evidence

.19:211 unit suites /5,098 passed /four existing skips;88 DOM,4 accessibility unit,84 quote parity;265 mocked browser (385.4 seconds),16 remaining browser (4.2min,3 optional screenshot skips); all5 live calculator surfaces including EMB/CAP additional-logo tiers. Build/lint/types/295 CSS/HTTP boot pass;485 routes in24 modules unchanged.21 focused policy cases pass; actual paper contains101 selected synthetic blocks: hub/detail/questions1 page each, handbook23 pages/all22 chapters including post-divider text, chart2 pages/all tested names.

Artifacts: **C:/Users/erik/.codex/visualizations/2026/09/07/01a07d90-9a4c-7e70-9e4e-c196377b7c6b**. policy-cms-{release-record,source-ci,heroku-verification,live-verification,local-gates}.json are authoritative. webstore-{worktree-record,original-baseline,css-measurement,paper-review}.json hold the next reviewed batch. webstore-isolated.config.cjs uses3420. Do not rerun one-shot installers/release helpers. After any uncertain push, inspect the actual Heroku SHA before retrying.
