...
- [ ] Record original four-width, populated/failure and printed states with synthetic reads.
- [ ] Consolidate CSS ownership, retain shared-module contracts, expose honest loading/empty/partial/error and keyboard states.
- [ ] Review source/CSV/paper and responsive interactions; keep real business writes/uploads/messages blocked.
