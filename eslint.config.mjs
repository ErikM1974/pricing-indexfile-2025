...
const STRICT_FILES = [
    ...
    ...CONTRACT_UI_FILES,
    ...QUICK_QUOTE_UI_FILES,
    ...EMBROIDERY_REFERENCE_UI_FILES,
    ...GARMENT_DESIGNER_UI_FILES,
...
export default [
    ...
    {
        files: ['shared_components/js/specialty-calculator-ui.js', ...CONTRACT_UI_FILES, ...QUICK_QUOTE_UI_FILES, ...EMBROIDERY_REFERENCE_UI_FILES, ...GARMENT_DESIGNER_UI_FILES, ...CATALOG_DISCOVERY_FILES, ...MAGIC_LINK_FILES, ...STAFF_REFERENCE_FILES, 'shared_components/js/storefront-navigation.js', 'shared_components/js/catalog-storefront-navigation.js', 'shared_components/js/campaign-storefront.js', ...POLICY_UI_FILES, 'shared_components/js/webstore-guide.js'],
