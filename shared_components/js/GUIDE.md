...
| `builders/dtf/index.js` | **DTF ESM entry point (real since 2026-07-08 D1)** — 12 window bridges incl. `window.DTFQuoteBuilder` (the shell listener instantiates from the bundle) |
...
| `builders/dtf/push.js` | **DTF D1 (2026-07-08)** — one-click push + preview/confirm (push-button-binding locks HERE); push state shell-side until D2 |
