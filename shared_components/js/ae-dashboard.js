...
(function () {
    ...
    // Card rendering moved to art-hub-ae.js (uses shared Caspio gallery DataPage)
    // Old code (renderArtRequestCards, buildColumnMap, etc.) removed 2026-03-15

    // ── Shared helpers (still used by loadReviewTab) ─────────────
