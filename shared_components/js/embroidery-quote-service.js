            ...
            if (pricingResults.manualServiceItems && pricingResults.manualServiceItems.length > 0) {
                for (const svc of pricingResults.manualServiceItems) {
                    ...
                    const itemData = {
                        ...
                        PrintLocation: svc.position || '',
                        PrintLocationName: svc.position || '',
                        ...
                        SizeBreakdown: JSON.stringify({ serviceType: svc.serviceType, stitchCount: svc.stitchCount, position: svc.position || '' }),
                        PricingTier: '',
                        ImageURL: '',
                        AddedAt: new Date().toISOString().replace(/\.\d{3}Z$/, ''),
                        LogoSpecs: ''
