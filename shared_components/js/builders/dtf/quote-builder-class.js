...
/* global dtfQuoteBuilder, DTFPricingService, DTFQuoteService, escapeHtml, showToast,
   ...
   updateTaxCalculation, showRecentCustomerOrders, removeRecentOrdersPanel,
   setupBeforeUnloadGuard, getServicePrice, updateAdditionalCharges,
   updateFeeTableRows, addNewRow, onStyleChange, selectColor, createChildRow,
   removeChildRow, updateExtendedSizeDisplay, applyMethodSwitchCustomer,
   history, clearQuickQuoteParams, assertQuoteEditable, setLtmControlState,
   getLtmControlState, renderLtmControlPanel, initLtmControlListeners,
   updatePerUnitPrice, updateQuantityNudge, parseRatePercent, alert,
