...
var StickerBannerSubmitForm = (function () {
    ...
    function buildFormHtml() {
        ...
        return '<div class="sbf-container">'
            ...
            + '    <div class="sbf-row">'
            + '      <div class="sbf-field">'
            + '        <label for="sbf-company" class="sbf-field-label">Company Name <span class="sbf-required">*</span></label>'
            ...
            + '      </div>'
            + '      <div class="sbf-field">'
            + '        <label for="sbf-sales-rep" class="sbf-field-label">Sales Rep</label>'
            ...
            + '    <div class="sbf-row">'
            + '      <div class="sbf-field">'
            + '        <label for="sbf-contact-name" class="sbf-field-label">Contact Name</label>'
            + '        <input type="text" class="sbf-input" id="sbf-contact-name" placeholder="First Last">'
            + '      </div>'
            + '      <div class="sbf-field">'
            + '        <label for="sbf-contact-email" class="sbf-field-label">Contact Email</label>'
            ...
            + '    <div class="sbf-row">'
            + '      <div class="sbf-field">'
            + '        <label for="sbf-design-num-sw" class="sbf-field-label">ShopWorks Design # <span class="sbf-required">*</span></label>'
            ...
            + '      </div>'
            + '      <div class="sbf-field">'
            + '        <label for="sbf-work-order" class="sbf-field-label">Work Order # (optional)</label>'
            ...
            + '    <div class="sbf-row">'
            + '      <div class="sbf-field">'
            + '        <label for="sbf-design-name" class="sbf-field-label">Design Name <span class="sbf-required">*</span></label>'
            ...
            + '      </div>'
            + '      <div class="sbf-field">'
            + '        <label for="sbf-due-date" class="sbf-field-label">Due Date</label>'
            ...
            + '    <div class="sbf-field">'
            + '      <label for="sbf-quantity" class="sbf-field-label">Estimated Quantity</label>'
            + '      <input type="number" class="sbf-input" id="sbf-quantity" placeholder="e.g. 250" min="1" step="1">'
            + '    </div>'

            // Instructions
            + '    <div class="sbf-field">'
            + '      <label for="sbf-instructions" class="sbf-field-label">Additional Instructions for Steve</label>'
    ...
    function buildStickerSpecsHtml() {
        return ''
            ...
            + '<div class="sbf-row">'
            + '  <div class="sbf-field">'
            + '    <label for="sbf-sticker-size" class="sbf-field-label">Size <span class="sbf-required">*</span></label>'
            ...
            + '    <label for="sbf-sticker-custom-w" class="sbf-field-label">Custom Dimensions (W × H, inches)</label>'
            ...
            + '<div class="sbf-row">'
            + '  <div class="sbf-field">'
            + '    <label for="sbf-sticker-material" class="sbf-field-label">Material</label>'
            ...
            + '  </div>'
            + '  <div class="sbf-field">'
            + '    <label for="sbf-sticker-shape" class="sbf-field-label">Shape</label>'
            ...
            + '<div class="sbf-row">'
            + '  <div class="sbf-field">'
            + '    <label for="sbf-sticker-cut" class="sbf-field-label">Cut Type</label>'
            ...
            + '  </div>'
            + '  <div class="sbf-field">'
            + '    <label for="sbf-sticker-application" class="sbf-field-label">Application</label>'
    ...
    function buildBannerSpecsHtml() {
        return ''
            ...
            + '<div class="sbf-row">'
            + '  <div class="sbf-field">'
            + '    <label for="sbf-banner-width" class="sbf-field-label">Width (inches) <span class="sbf-required">*</span></label>'
            ...
            + '  </div>'
            + '  <div class="sbf-field">'
            + '    <label for="sbf-banner-height" class="sbf-field-label">Height (inches) <span class="sbf-required">*</span></label>'
            ...
            + '<div class="sbf-row">'
            + '  <div class="sbf-field">'
            + '    <label for="sbf-banner-material" class="sbf-field-label">Material <span class="sbf-required">*</span></label>'
            ...
            + '  </div>'
            + '  <div class="sbf-field">'
            + '    <label for="sbf-banner-sides" class="sbf-field-label">Sides</label>'
            ...
            + '<div class="sbf-row">'
            + '  <div class="sbf-field">'
            + '    <label for="sbf-banner-hemming" class="sbf-field-label">Hemming</label>'
            ...
            + '  </div>'
            + '  <div class="sbf-field">'
            + '    <label for="sbf-banner-grommets" class="sbf-field-label">Grommets</label>'
            ...
            + '<div class="sbf-row">'
            + '  <div class="sbf-field">'
            + '    <label for="sbf-banner-poles" class="sbf-field-label">Pole Pockets</label>'
            ...
            + '  </div>'
            + '  <div class="sbf-field">'
            + '    <label for="sbf-banner-use" class="sbf-field-label">Indoor / Outdoor</label>'
            ...
            // Background color
            + '<div class="sbf-field" style="max-width:340px;">'
            + '  <label for="sbf-banner-bg" class="sbf-field-label">Background Color</label>'
