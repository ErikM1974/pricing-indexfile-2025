...
var MockupSubmitForm = (function () {
    ...
    var API_BASE = (window.APP_CONFIG && window.APP_CONFIG.API && window.APP_CONFIG.API.BASE_URL)
        || '';
    if (!API_BASE) console.error('[mockup-submit-form] APP_CONFIG.API.BASE_URL missing — the proxy host is not configured');
    ...
    function buildFormHtml() {
        return '<div class="msf-container">'
            ...
            + '    <div class="msf-row">'
            + '      <div class="msf-field">'
            + '        <label for="msf-company" class="msf-field-label">Company Name <span class="msf-required">*</span></label>'
            ...
            + '      </div>'
            + '      <div class="msf-field">'
            + '        <label for="msf-sales-rep" class="msf-field-label">Sales Rep</label>'
            ...
            + '    <div class="msf-row">'
            + '      <div class="msf-field">'
            + '        <label for="msf-design-number" class="msf-field-label">Design Number <span class="msf-required msf-design-required" id="msf-design-asterisk">*</span></label>'
            ...
            + '      </div>'
            + '      <div class="msf-field">'
            + '        <label for="msf-design-name" class="msf-field-label">Design Name</label>'
            ...
            + '      </div>'
            + '      <div class="msf-field">'
            + '        <label for="msf-placement" class="msf-field-label">Placement <span class="msf-required">*</span></label>'
            ...
            + '      <label for="msf-fabric-type" class="msf-field-label">Fabric/Garment Type</label>'
            ...
            + '    <div class="msf-row">'
            + '      <div class="msf-field">'
            + '        <label for="msf-width" class="msf-field-label">Width (inches)</label>'
            + '        <input type="text" class="msf-input" id="msf-width" placeholder="e.g., 3.5">'
            + '      </div>'
            + '      <div class="msf-field">'
            + '        <label for="msf-height" class="msf-field-label">Height (inches)</label>'
            ...
            // Thread Colors
            + '    <div class="msf-field">'
            + '      <label for="msf-thread-search" class="msf-field-label">Thread Colors</label>'
            ...
            + '    <div class="msf-row">'
            + '      <div class="msf-field">'
            + '        <label for="msf-due-date" class="msf-field-label">Due Date</label>'
            + '        <input type="date" class="msf-input" id="msf-due-date">'
            + '      </div>'
            + '      <div class="msf-field">'
            + '        <label for="msf-work-order" class="msf-field-label">Work Order #</label>'
            ...
            // Instructions
            + '    <div class="msf-field">'
            + '      <label for="msf-instructions" class="msf-field-label">Additional Instructions</label>'
