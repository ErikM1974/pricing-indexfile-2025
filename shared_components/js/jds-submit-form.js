...
var JDSSubmitForm = (function () {
    ...
    function renderFormView() {
        ...
        container.innerHTML = ''
            ...
            + '      <div class="jds-row">'
            + '        <div class="jds-field">'
            + '          <label for="jds-company" class="jds-field-label">Company Name <span class="jds-required">*</span></label>'
            ...
            + '        </div>'
            + '        <div class="jds-field">'
            + '          <label for="jds-sales-rep" class="jds-field-label">Sales Rep</label>'
            ...
            + '      <div class="jds-row">'
            + '        <div class="jds-field">'
            + '          <label for="jds-contact-name" class="jds-field-label">Contact Name</label>'
            + '          <input type="text" class="jds-input" id="jds-contact-name" placeholder="First Last">'
            + '        </div>'
            + '        <div class="jds-field">'
            + '          <label for="jds-contact-email" class="jds-field-label">Contact Email</label>'
            ...
            + '      <div class="jds-row">'
            + '        <div class="jds-field">'
            + '          <label for="jds-design-num-sw" class="jds-field-label">ShopWorks Design # <span class="jds-required">*</span></label>'
            ...
            + '        </div>'
            + '        <div class="jds-field">'
            + '          <label for="jds-work-order" class="jds-field-label">Work Order # (optional)</label>'
            ...
            + '      <div class="jds-row">'
            + '        <div class="jds-field">'
            + '          <label for="jds-design-name" class="jds-field-label">Design Name <span class="jds-required">*</span></label>'
            ...
            + '        </div>'
            + '        <div class="jds-field">'
            + '          <label for="jds-due-date" class="jds-field-label">Due Date</label>'
            ...
            + '      <div class="jds-row">'
            + '        <div class="jds-field">'
            + '          <label for="jds-decoration" class="jds-field-label">Decoration Method <span class="jds-required">*</span></label>'
            ...
            + '        </div>'
            + '        <div class="jds-field">'
            + '          <label for="jds-engrave-color" class="jds-field-label">Engrave / Print Color</label>'
            + '          <input type="text" class="jds-input" id="jds-engrave-color" placeholder="e.g. Silver on Black" value="' + escapeHtml(row.EngraveColor || '') + '">'
            + '        </div>'
            + '      </div>'
            + '      <div class="jds-field">'
            + '        <label for="jds-imprint-placement" class="jds-field-label">Imprint Placement</label>'
            ...
            + '      <div class="jds-field">'
            + '        <label for="jds-quantity" class="jds-field-label">Estimated Quantity</label>'
            ...
            //   Instructions
            + '      <div class="jds-field">'
            + '        <label for="jds-instructions" class="jds-field-label">Additional Instructions for Steve</label>'
    ...
    function handleSubmit() {
        ...
        if (!getSubmitterEmail()) {
            ...
            console.error('[JdsSubmitForm] No staff session — submit blocked');
            return;
        }
        ...
        uploadFilesSequentially()
            .then(function (upload) {
                ...
                var payload = {
                    ...
                    Order_Type_Source: decoration || 'JDS',
