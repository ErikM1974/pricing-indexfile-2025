/**
 * Additional Logo Pricing Table - Cap Embroidery
 * Fetches pricing from CAP-AL API endpoint and populates simple pricing table
...
(function() {
    ...
    async function initAdditionalLogoPricing() {
        console.log('[AdditionalLogo-CAP-Simple] Initializing...');
        ...
        try {
            ...
            console.log('[AdditionalLogo-CAP-Simple] ✅ Initialized successfully');

        } catch (error) {
            console.error('[AdditionalLogo-CAP-Simple] ❌ Error:', error);
    ...
    async function fetchPricingFromAPI() {
        console.log('[AdditionalLogo-CAP-Simple] Fetching from API:', API_ENDPOINT);
        ...
        console.log('[AdditionalLogo-CAP-Simple] API data received:', data);
        ...
        if (data.allEmbroideryCostsR && Array.isArray(data.allEmbroideryCostsR)) {
            ...
            console.log('[AdditionalLogo-CAP-Simple] Extracted pricing:', pricing);
            console.log('[AdditionalLogo-CAP-Simple] Config:', config);
    ...
    function populatePricingTable(data) {
        ...
        console.log('[AdditionalLogo-CAP-Simple] ✅ Table populated');
    }
    ...
    function updateCell(cellId, price) {
        ...
        if (!cell) {
            console.warn(`[AdditionalLogo-CAP-Simple] ⚠️ Cell not found: ${cellId}`);
            return;
        }
