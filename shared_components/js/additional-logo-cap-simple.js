...
(function() {
    ...
    if (!API_BASE) console.error('[additional-logo-cap-simple] APP_CONFIG.API.BASE_URL missing — the proxy host is not configured');
    const API_ENDPOINT = `${API_BASE}/api/pricing-bundle?method=CAP-AL`;
