...
export default {
    ...
    rules: {
        ...
        // icon fonts (Font Awesome) have no meaningful generic fallback: the glyphs are private-use codepoints
        'font-family-no-missing-generic-family-keyword': [true, { ignoreFontFamilies: ['/^Font Awesome/'] }],
