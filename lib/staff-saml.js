...
const REP_PERMISSION_BY_EMAIL = {
  ...
  // Ruth 2026-08-10 — she owns 190 orders in ORDER_ODBC and had no way to see her own
  // past-due list; the AE endpoints 404'd her and the page gate turned her away.
  // Her inbox is ruth@ (ruthie@ is not a real account) and ORDER_ODBC spells her
  // 'Ruthie Nhoung' — see AE_REGISTRY in the proxy's src/routes/ae-dashboard.js.
