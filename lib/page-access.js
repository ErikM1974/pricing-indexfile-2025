...
const ADMIN_DEFAULT_PAGES = new Set([
    ...
    // Brand Standards (2026-09-07): the token-driven design reference; admin because it is a working document
    ...
    // Dedicated route enforces admin on every related data/document response too.
    'december-finish-line.html',
