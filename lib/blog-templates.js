 ...
 * Styling uses the shared design tokens and components, scoped by
...
<head>
    ...
    <link rel="stylesheet" href="/shared_components/css/blog.css?v=2026.09.12.2">
    ${jsonLd ? `<script type="application/ld+json">${JSON.stringify(jsonLd).replace(/</g, '\\u003c')}</script>` : ''}
    ${extraHead}
</head>
<body class="blog-body" data-ui="unified" data-surface="storefront">
...
function renderIndex(posts, { category = '' } = {}) {
  ...
  const body = `
    <main id="main-content" class="blog-wrap">
        <div class="blog-hero">
...
function renderPost(post, bodyHtml, related = []) {
  ...
  const body = `
    <main id="main-content" class="blog-wrap blog-wrap--post">
