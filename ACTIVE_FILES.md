...
| `/pages/css/dst-viewer.css` | Embroidery Studio styles — dark instrument UI (toolrail, stage HUD, sidebar tabs, picker modal) + print-only approval sheet | CSS variables, DM Mono/Outfit | ✅ Active |
