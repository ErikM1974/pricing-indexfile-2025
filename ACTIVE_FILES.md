...
|---|---|---|---|
| `/memory/december-finish-line.md` | Local source map for the attached December Finish Line planning workspace and original financial reports; agreed assumptions and future private website integration notes. Contains no imported payroll or customer dataset. | AGENTS.md, memory/INDEX.md, future Codex project tasks | Active (added 2026-09-14) |
