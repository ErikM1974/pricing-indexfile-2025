...
| `/dashboards/payroll.html` | **NEW (2026-07-27)** 🔒 Payroll — vacation/sick balances, hours by pay period, and packet upload (PDF → verified → saved). **Admin only**: `createCrmProxy('payroll', ['admin'])` + `Staff_Page_Access` row. **Never displays pay rates or salaries** (Erik 2026-07-27). | payroll.js, payroll.css, `/api/crm-proxy/payroll/*` | ✅ Active |
