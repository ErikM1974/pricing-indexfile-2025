...
| `/tests/ui/test-ae-mission-control-stub.js` | Fetch stub for the Mission Control harness — crm-session (admin), ae-dashboard summary (per-rep fixtures incl. XSS probe), marketing-shipments items+POST, lead-outreach preview/send, inbound-today, art-notifications | — | ✅ Active |
