...
| `/pages/fall-catalog-2026.html` | **NEW (2026-07-23)** "Fall Catalog '26" new-arrivals landing page — curated lookbook of the 170+ new SanMar Fall 2026 styles (21 brands, 10 categories, search + brand jump-nav). Data is PDF-sourced (NOT the product DB — new seasonal styles aren't in Sanmar_Bulk Feb2024); images = deterministic `cdnm.sanmar.com/catalog/images/{STYLE}.jpg`; every card → Request-a-Quote (NO price shown — Erik's iron rule, PDF lists SanMar blank list prices not NWCA decorated). Linked from catalog nav + drawer + promo banner. | nwca-2026-core.css, fall-catalog-2026.css/js, product-search-service.js, decoration-methods.js, app-modern.js, brands-flyout.js, nav-dropdown.js, quote-cart-store.js | ✅ Active |
| `/pages/css/fall-catalog-2026.css` | Fall Catalog '26 page layer CSS (dark-green hero, sticky search/category/brand toolbar, product card grid, closing CTA band) | nwca-2026-core.css | ✅ Active (NEW 2026-07-23) |
| `/pages/js/fall-catalog-2026.js` | Fall Catalog '26 render logic — embedded 179-style dataset (brand/category/page from the PDF style index), builds brand sections + category chips + brand jump-nav, client search/filter, SanMar-CDN images w/ broken-image fallback, cards deep-link Request-a-Quote (`?style=&product=&source=`) | — (self-contained; no API) | ✅ Active (NEW 2026-07-23) |
