...
- `shared_components/js/headwear-classifier.js` — cap / flat headwear / garment decision from category, subcategory, title and (blank category only) cap shapes and description; handles Richardson caps with no category. The single cap-vs-garment rule for the EMB/SCP builders, DTF search, product page, embroidery calculators and Quick Quote (2026-09-16; memory/HEADWEAR_ALIGNMENT_2026-09.md).
...
- tests/unit/headwear-surfaces-parity.test.js — Rule 9 for headwear: the EMB/SCP builders, product page, flat calculator, cap calculator and Quick Quote make the same cap/garment call on every live fixture row.
