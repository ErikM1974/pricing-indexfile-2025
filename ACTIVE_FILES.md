...
| `/shared_components/js/builders/dtg/index.js` | **DTG ESM entry point (Batch 5, 2026-07-09 — decomposition COMPLETE)** — shared-error bridges + side-effect `import './form-core.js'` boot. The page's ONLY builder script; the 5,498-line `dtg-inline-form.js` monolith is DELETED (recovery: `git show v2026.07.09.12:shared_components/js/dtg-inline-form.js`). | scripts/build.js; dtg-quote-builder.html | ✅ Active |
