...
| `/shared_components/js/builders/dtf/index.js` | **DTF ESM entry point (roadmap 0.4; real modules since 2026-07-08 D1)** — the ONE sanctioned window re-export surface (12 bridges incl. window.DTFQuoteBuilder for the shell's init). | scripts/build.js; dtf-quote-builder.html | ✅ Active |
