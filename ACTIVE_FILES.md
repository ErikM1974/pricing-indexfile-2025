...
| `/pages/forms/nwca-form-shared.js` | **NEW (2026-07-11)** Shared form behaviors — `NWCAForm.init({onAfterClear})`: print button, confirm-guarded Clear, dirty beforeunload guard (cleared after print). Forms save NOTHING server-side. | — | ✅ Active |
