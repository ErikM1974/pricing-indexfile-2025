...
| `/shared_components/js/builders/scp/index.js` | **SCP ESM entry point (roadmap 0.4; real modules since 2026-07-08 S1a)** — the ONE sanctioned window re-export surface for the SCP decomposition (26 bridges); parse-time execution beats DOMContentLoaded so the monolith remainder + HTML handlers always find them. | scripts/build.js; screenprint-quote-builder.html | ✅ Active |
