...
In progress: shared_components/css/vendor-invoice.css — opt-in invoice dialog and complete print layout for unified purchasing pages. Legacy sanmar-invoice-viewer.css remains for AE Mission Control.

In progress: shared_components/css/purchasing-workspaces.css — scoped Purchasing Portal/Payables arrangements. Two-page migration and invoice viewer review pending; current production unchanged.
