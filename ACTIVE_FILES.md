...
| `/pages/css/custom-carhartt.css` | Landing-page layer for /custom-carhartt (hero, family grids, tiles, FAQ, CTA band) on core tokens | nwca-2026-core.css | ✅ Active (NEW 2026-07-12) |
| `/pages/js/custom-carhartt.js` | Chrome wiring only for /custom-carhartt (drawer + masthead search → /?q=), mirrors product-2026.js wireChrome; page content is static | — | ✅ Active (NEW 2026-07-12) |
