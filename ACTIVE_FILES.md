...
| `/tests/ui/test-phase1-widgets.html` | Phase 1 widgets harness — real Win Bell/Pride Wall/My Stuff controllers over mocked APP_CONFIG + fetch; exercises fresh-win celebration (ticker + bell + confetti), 6-tile wall rotation, pin/unpin persistence | phase1-widgets.css, test-phase1-widgets-mocks.js, test-phase1-widgets.js/.css | ✅ Active |
