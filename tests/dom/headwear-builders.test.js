...
globalThis.getSwatchAttrs = () => '';
globalThis.qbPaintSwatches = () => {};
...
describe('reopened EMB quote: price change notice', () => {
    ...
    test('the notice is a persistent, dismissible banner above the products, text only', async () => {
        ...
        expect(banner.className).toBe('alert alert-warn emb-screen-notice');   // the shared warning alert + the builder's notice layout
