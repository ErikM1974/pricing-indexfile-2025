...
test.each([
    ['pages/js/sample-cart-page.js', ['sortSizesByOrder', 'updateCartSummary']],
    ['pages/js/sample-checkout.js', ['hasPaid', 'paidSubtotal']],
    ['pages/js/quote-cart-page.js', ['formatPrice', 'num', 'parseRange', 'groupIdFor', 'optionsFor', 'buildCart', 'nextTierMin']],
