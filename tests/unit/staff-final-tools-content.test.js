...
const original = require('../fixtures/staff-final-tools-original-content.json');
...
test.each(original.pages)('$file preserves original labels, fields, links and identifiers', record => {
    let html = require('../helpers/holiday-source-mappings')(record.file, fs.readFileSync(path.join(root, record.file), 'utf8').replace(/\r\n/g, '\n'));
