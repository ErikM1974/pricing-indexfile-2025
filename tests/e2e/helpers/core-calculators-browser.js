...
const root=path.resolve(__dirname,'../../..'),original=require('../../fixtures/core-calculators-original-content.json');
...
async function open(page,state={}){
 ...
 await page.context().route('**/*',async route=>{
  ...
  if(p==='/api/pricing-bundle'){
   const method=u.searchParams.get('method'),files={DTF:'dtf-bundle.json',EMB:'emb-bundle-PC54.json','EMB-AL':'emb-al-bundle.json',CAP:'cap-bundle-C112.json','CAP-AL':'cap-al-bundle.json','CAP-PUFF':'cap-puff-bundle.json',ScreenPrint:'scp-bundle-PC61.json'};
