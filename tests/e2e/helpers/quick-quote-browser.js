...
async function open(page,state={}){
 ...
 await page.context().route('**/*',async route=>{
  ...
  if(p==='/api/decoration-methods')return route.fulfill({json:{rules:[{category:'T-Shirts',EMB:true,DTG:true,SCP:true,DTF:true},{category:'Caps',EMB:false,DTG:false,SCP:false,DTF:false},{category:'Personal Protection',EMB:true,DTG:false,SCP:true,DTF:true}],overrides:[]}});
