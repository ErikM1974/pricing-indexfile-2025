            ...
            async handleQuoteSubmit(e) {
                ...
                try {
                    ...
                    if (this.currentQuote.hasLTM) {
                        ...
                        priceBreakdownHtml = `
                            <div class="price-breakdown">
                                <h3>Price Per Item Breakdown:</h3>
                                ...
                                <div class="price-line price-total">
                                    ...
                                    <span>$${ltmPerPiece.toFixed(2)}</span>
                                </div>
                            </div>
                        `;
                    }
                    ...
                    setTimeout(() => {
                        ...
                        this.salesRep.value = 'ruthie@nwcustomapparel.com';
                    }, 2000);
        ...
        document.getElementById('buyersGuideModal').addEventListener('click', function(e) {
            if (e.target === this) {
                closeBuyersGuide();
            }
        });
        ...
        document.getElementById('emailGuideModal').addEventListener('click', function(e) {
            if (e.target === this) {
        ...
        document.getElementById('emailGuideForm').addEventListener('submit', async (e) => {
            e.preventDefault();
