/**
 * Quick check if our 15 products are marked as new
 */

const ourStyles = ['EB120','EB121','CT100617','CT103828','CT104670','CT104597','DT620','DT624','NE410','ST850','ST851','BB18200','CS410','CS415','EB201'];

fetch('https://caspio-pricing-proxy-ab30a049961a.herokuapp.com/api/products/new?limit=1000')
    .then(r => r.json())
    .then(data => {
        ...
        console.log(`\nTotal products marked as new in database: ${data.products.length}`);
