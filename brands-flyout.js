...
class BrandsFlyout {
    ...
    createBrandLink(brand, logo) {
        ...
        const BRAND_LANDING_PAGES = { 'Carhartt': '/custom-carhartt', 'Richardson': '/custom-richardson', 'Nike': '/custom-nike', 'New Era': '/custom-new-era', 'Sport-Tek': '/custom-sport-tek', 'OGIO': '/custom-ogio', 'District': '/custom-district', 'Port Authority': '/custom-port-authority', 'Port & Co': '/custom-port-and-company', 'Port & Company': '/custom-port-and-company' };
